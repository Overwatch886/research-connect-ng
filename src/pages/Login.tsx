...
import { FileText, Mail, Lock, ArrowRight, Eye, EyeOff, Loader2 } from "lucide-react";
...
const Login = () => {
    ...
    try {
      ...
      if (/not enabled|unsupported provider/i.test(msg)) {
        ...
        toast({
          ...
          description: msg || "Failed to initiate Google sign-in.",
          variant: "destructive",
        });
      }
    } finally {
  ...
  const handleUniversitySso = () => {
    toast({
      title: "University SSO Pilot",
      description: "Direct Nigerian campus SSO (eduID/NREN) is rolling out to partner universities. Please sign in with your student or staff email.",
    });
  };
      ...
      <div className="hidden lg:flex flex-1 hero-gradient items-center justify-center p-8">
        <div className="max-w-md text-center text-primary-foreground">
          <h2 className="font-display text-3xl font-bold mb-4">
            Quality Research Starts Here
          </h2>
          <p className="text-primary-foreground/70 mb-8">
            Join thousands of Nigerian students conducting and participating in meaningful academic research.
          </p>
          <div className="grid grid-cols-2 gap-4">
